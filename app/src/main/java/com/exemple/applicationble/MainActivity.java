...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCommu.setOnClickListener(v -> {
            // Démarrer le ForegroundService (pour le scan BLE et autres opérations)
            startForegroundService();
            // Démarrer également le MonitoringService pour initialiser bobManager
            Intent intent = new Intent(MainActivity.this, Helper_Comu.class);
            startActivity(intent);
        });
