    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonConnect.setOnClickListener(view -> {
            ...
            if (!isValidEmail(emailOrPseudo) && !isValidUsername(emailOrPseudo)) {
                Toast.makeText(LoginActivity.this, "Veuillez entrer un email ou un nom d'utilisateur valide", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            apiService.loginUser(loginData).enqueue(new Callback<>() {
                ...
                public void onResponse(Call<LoginData> call, Response<LoginData> response) {
                    if (response.isSuccessful() && response.body() != null) {
                        Toast.makeText(LoginActivity.this, "Identifiants validés", Toast.LENGTH_SHORT).show();
                        ...
                        apiService.getUsersData().enqueue(new Callback<>() {
                            ...
                            public void onResponse(Call<List<UsersData2>> call, Response<List<UsersData2>> response) {
                                if (response.isSuccessful() && response.body() != null && !response.body().isEmpty()) {
                                    ...
                                    Toast.makeText(LoginActivity.this, "Erreur lors de la récupération des données utilisateur", Toast.LENGTH_SHORT).show();
                                }
                            }
        ...
        backButton.setOnClickListener(v -> {
            if (LoginActivity.this instanceof OnBackPressedDispatcherOwner) {
                OnBackPressedDispatcherOwner dispatcherOwner = (OnBackPressedDispatcherOwner) LoginActivity.this;
